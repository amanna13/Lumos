                ...
                <p className="text-sm text-slate-500 dark:text-slate-400">
                  ...
                  {winner.proposer && winner.proposer !== "Unknown" && 
                    <span className="ml-2 text-xs">
                      ({winner.proposer.substring(0, 6)}...{winner.proposer.length > 8 ? winner.proposer.substring(winner.proposer.length - 4) : ""})
                    </span>
                  }
                </p>
                  ...
                  {rankedProposals.map((proposal, index) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <div className="text-sm font-medium">{getProposalTitle(proposal) || "Unnamed Proposal"}</div>
                      </td>
